<template lang='pug' src='./tab-treatments-tmj.pug'></template>
  ...
  data () {
    return {
      swiperOption: {
        ...
        navigation: {
          prevEl: '.tab-treatments-tmj__prev-btn',
          nextEl: '.tab-treatments-tmj__next-btn'
        },
        pagination: {
          el: '.tab-treatments-tmj__pagination',
          clickable: true,
          bulletClass: 'tab-treatments-tmj__bullet',
          bulletActiveClass: 'tab-treatments-tmj__bullet-active',
